...
namespace VuLinh_BTH2_3_11.Controllers
{
    public class StudentController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("StudentID,StudentName,FacultyID" )] Students std)
        {
        ...
        public async Task<IActionResult> Edit(string id, [Bind("StudentID,StudentName")] Students std)
        {
            if (id != std.StudentID)
            {
                return View("NotFound");
